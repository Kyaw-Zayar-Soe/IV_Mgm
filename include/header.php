...
<head>
  ...
  <link rel="stylesheet" href="<?php echo$root;?>assets/fontawesome-free-5.15.4-web/css/all.min.css" />
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <div class="container-fluid pr-4 pl-4">
      ...
      <div class="collapse navbar-collapse" id="navbarButtonsExample">
        <div class="d-flex">
          <a type="button" class="btn btn-warning me-3 text-white" href="<?php echo $root; ?>">
          ...
          <!-- Account -->
          <a href="<?php echo $root.'logout.php'?>" type="button" class="btn btn-dark me-3 text-white">
            <span class="fa fa-user"></span>
